...
│       ├── select_and_analyze.py # GUI entrypoint
│       ├── listen_and_analyze.py # DICOM listener entrypoint
...
├── docs/                         # Sphinx docs and project references
...
See [docs/examples.rst](../examples.rst) for multiple usage patterns:
