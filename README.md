...
The analyzer backend is published on PyPI as `alexandria-project`. Install it
automatically as part of this package, or install it explicitly first if you
prefer:
...
See [docs/development/SPHINX_GUIDE.md](docs/development/SPHINX_GUIDE.md) for detailed documentation building instructions.
