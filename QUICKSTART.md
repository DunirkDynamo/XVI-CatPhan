...
APIs, see [docs/reference/QUICK_REFERENCE.md](docs/reference/QUICK_REFERENCE.md).
...
catphan-listen /path/to/receiver --interval 10

# Wait 5 cycles before processing (default: 8)
catphan-listen /path/to/receiver --wait-cycles 5
```
